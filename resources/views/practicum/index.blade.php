<x-layouts.app>
    ...
    <x-data-table url="{{ route('api.practicum.table') }}" action-url="practicums/" :columns="[
        ...
        ['label' => 'Semester', 'field' => 'semester', 'sortable' => true],
        ['label' => 'Prodi', 'field' => 'for_prodi', 'sortable' => true],
    ]" :has-actions="true"
        table-id="practicum-table" search-input-id="search-practicum" btn-create-id="btn-create-practicum" primary="kode_praktikum" />
