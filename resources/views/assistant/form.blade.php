...
<script type="module">
    $(document).ready(function() {
        ...
        $(document).on('input', '#nim', function() {
            ...
            $('#password').closest('.input-component').removeClass('border-[#C9C6C5]').addClass(
                'border-key-secondary');
            $('#password_confirmation').closest('.input-component').removeClass('border-[#C9C6C5]')
                .addClass('border-key-secondary');
            ...
            if (nimValue.length >= 5) {
                ...
                $('#angkatan').closest('.input-component').removeClass('border-[#C9C6C5]').addClass(
                    'border-key-secondary');
            } else {
                $('#angkatan').val('');
                $('#angkatan').closest('.input-component').removeClass('border-key-secondary').addClass(
                    'border-[#C9C6C5]');
            }
        });
    });
